...
Encrypted storage of P2P Ed25519 node keys using SecretsStore (AES-256-GCM), with auto-migration from legacy plaintext files and backward-compatible fallback.
