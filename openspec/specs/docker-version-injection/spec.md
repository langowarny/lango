...
Build-time version and build timestamp injection for Docker images, ensuring `lango version` reports accurate version information in containerized deployments.
