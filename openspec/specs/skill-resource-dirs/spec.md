...
Skill resource directory support — enables importing and persisting resource files (scripts, references, assets) alongside SKILL.md files during skill import operations.
