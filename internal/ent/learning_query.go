...
func (_q *LearningQuery) Order(o ...learning.OrderOption) *LearningQuery {
	_q.order = append(_q.order, o...)
	return _q
}

// First returns the first Learning entity from the query.
// Returns a *NotFoundError when no Learning was found.
func (_q *LearningQuery) First(ctx context.Context) (*Learning, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{learning.Label}
	}
	return nodes[0], nil
}
...
// FirstID returns the first Learning ID from the query.
// Returns a *NotFoundError when no Learning ID was found.
...
// Only returns a single Learning entity found by the query, ensuring it only returns one.
// Returns a *NotSingularError when more than one Learning entity is found.
// Returns a *NotFoundError when no Learning entities are found.
func (_q *LearningQuery) Only(ctx context.Context) (*Learning, error) {
	...
	case 0:
		return nil, &NotFoundError{learning.Label}
	default:
		return nil, &NotSingularError{learning.Label}
	}
}
...
// OnlyID is like Only, but returns the only Learning ID in the query.
// Returns a *NotSingularError when more than one Learning ID is found.
...
func (_q *LearningQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	...
	case 0:
		err = &NotFoundError{learning.Label}
	default:
		err = &NotSingularError{learning.Label}
	}
	return
}
...
func (_q *LearningQuery) All(ctx context.Context) ([]*Learning, error) {
	...
	qr := querierAll[[]*Learning, *LearningQuery]()
	return withInterceptors[[]*Learning](ctx, _q, qr, _q.inters)
}
...
func (_q *LearningQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
	...
	if err = _q.Select(learning.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *LearningQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, _q, querierCount[*LearningQuery](), _q.inters)
}
...
// Clone returns a duplicate of the LearningQuery builder, including all associated steps. It can be
...
func (_q *LearningQuery) Clone() *LearningQuery {
	...
	return &LearningQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]learning.OrderOption{}, _q.order...),
		inters:     append([]Interceptor{}, _q.inters...),
		predicates: append([]predicate.Learning{}, _q.predicates...),
...
func (_q *LearningQuery) GroupBy(field string, fields ...string) *LearningGroupBy {
	...
	grbuild := &LearningGroupBy{build: _q}
	grbuild.flds = &_q.ctx.Fields
	grbuild.label = learning.Label
...
func (_q *LearningQuery) Select(fields ...string) *LearningSelect {
	...
	sbuild := &LearningSelect{LearningQuery: _q}
	sbuild.label = learning.Label
...
func (_q *LearningQuery) prepareQuery(ctx context.Context) error {
...
func (_q *LearningQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Learning, error) {
	var (
		nodes = []*Learning{}
		_spec = _q.querySpec()
	)
	_spec.ScanValues = func(columns []string) ([]any, error) {
		return (*Learning).scanValues(nil, columns)
	}
	_spec.Assign = func(columns []string, values []any) error {
		node := &Learning{config: _q.config}
...
func (_q *LearningQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := _q.querySpec()
...
func (_q *LearningQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(learning.Table, learning.Columns, sqlgraph.NewFieldSpec(learning.FieldID, field.TypeUUID))
	_spec.From = _q.sql
...
func (_q *LearningQuery) sqlQuery(ctx context.Context) *sql.Selector {
	builder := sql.Dialect(_q.driver.Dialect())
	t1 := builder.Table(learning.Table)
	columns := _q.ctx.Fields
	if len(columns) == 0 {
		columns = learning.Columns
	}
...
func (_g *LearningGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*LearningQuery, *LearningGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *LearningGroupBy) sqlScan(ctx context.Context, root *LearningQuery, v any) error {
...
func (_s *LearningSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*LearningQuery, *LearningSelect](ctx, _s.LearningQuery, _s, _s.inters, v)
}

func (_s *LearningSelect) sqlScan(ctx context.Context, root *LearningQuery, v any) error {
