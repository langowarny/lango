...
func (_d *ConfigProfileDelete) Where(ps ...predicate.ConfigProfile) *ConfigProfileDelete {
...
func (_d *ConfigProfileDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(configprofile.Table, sqlgraph.NewFieldSpec(configprofile.FieldID, field.TypeUUID))
...
type ConfigProfileDeleteOne struct {
	_d *ConfigProfileDelete
}

// Where appends a list predicates to the ConfigProfileDelete builder.
func (_d *ConfigProfileDeleteOne) Where(ps ...predicate.ConfigProfile) *ConfigProfileDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *ConfigProfileDeleteOne) Exec(ctx context.Context) error {
	n, err := _d._d.Exec(ctx)
	switch {
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{configprofile.Label}
	default:
		return nil
	}
}
