...
func ActionValidator(a Action) error {
	switch a {
	case ActionToolCall, ActionKnowledgeSave, ActionLearningSave, ActionSkillCreate, ActionSkillExecute, ActionKnowledgeSearch, ActionApprovalRequest, ActionApprovalResponse:
		return nil
	default:
